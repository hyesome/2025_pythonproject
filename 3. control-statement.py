...
test = [
    ...
    },
    {
        'name': 'bbb',
        'number': 10102,
        'math': [1, 5, 2, 4, 5, 3, 1, 2, 3, 4],
        'korean': [2, 3, 2, 4, 4, 3, 1, 2, 3, 4],
        'english': [4, 3, 2, 4, 5, 3, 1, 2, 3, 4],
        'science': [6, 3, 2, 4, 3, 3, 3, 2, 3, 4],
    },
    {
        'name': 'ccc',
        'number': 10103,
        'math': [1, 3, 2, 4, 5, 3, 1, 2, 3, 4],
        'korean': [1, 3, 3, 4,2, 4, 5, 3, 3, 4],
        'english': [1, 3, 2, 4, 5, 3, 1, 2, 3, 4],
        'science': [1, 3,3, 1, 2,  3, 1, 2, 3, 4],
    },
    {
        'name': 'ddd',
        'number': 10104,
        'math': [1, 3, 2, 3, 1, 2,  1, 2, 3, 4],
        'korean': [4, 1, 2, 4, 5, 3, 2, 4, 5,  4],
        'english': [4, 3, 2, 4, 5, 3, 1, 2, 3, 4],
        'science': [4, 2, 4, 5, 5, 3, 1, 2, 3, 4],
    },
    {
        'name': 'eee',
        'number': 10105,
        'math': [1, 3, 4, 5, 3, 2, 4,  2, 3, 4],
        'korean': [1,5, 3, 1, 2, 3, 1, 2, 3, 4],
        'english': [1, 1, 2, 4, 5, 3, 1, 2, 3, 4],
        'science': [1, 3, 2, 4, 5, 3, 2, 4, 3, 4],
    }
]
correct_answer = {
    'math': [1, 3, 2, 4, 5, 3, 2, 4,3, 4],
    'korean': [2, 3, 2, 4,3, 2, 4, 2, 3, 4],
    'english': [3, 1, 2, 4, 3, 2, 4,2, 3, 4],
    'science': [4, 3, 2,3, 2, 4, 1, 2, 3, 4],
}
